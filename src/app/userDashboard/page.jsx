...
function Admin() {
  ...
  const tableHeading = [
    ...
    },
    {
      ...
      cell: row => (
        <div className='flex justify-between'>
          <button onClick={() => editProduct(row)} className='text-green-500 text-[1.5rem] hover:bg-green-300 hover:rounded-full active:border-2 active:border-green-700 p-1'><FaRegEdit /></button>
